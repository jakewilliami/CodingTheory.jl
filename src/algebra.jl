...
"""
	Polynomial(A::Union{Tuple, AbstractArray}, n::Int) -> Polynomial
...
Returns
  - Polynomial: A polynomial modulo n.
"""
Polynomial(A::Union{Tuple, Vector{T}}, n::Int) where {T} = mod(Polynomial(A), n)
...
function parity_check(M::AbstractArray{Int}, n::Int)
	has_identity(M) || throw(error("This matrix is not in normal form.  Use normal_form or equivalent_code."))
